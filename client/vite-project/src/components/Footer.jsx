  ...
  return (
    <div className='w-[100vw] h-[250px] bg-black pl-16 pt-4 flex'>
        <div className='w-1/4'>
            ...
            <div className='text-white pt-4 pl-4 hover:text-blue-500 flex items-center justify-start cursor-pointer'><span className='text-white text-lg'><MdLocalPhone /></span>+91-9817766364</div>
            <div className='text-white pt-4 pl-4 hover:text-blue-500 flex items-center justify-start cursor-pointer'><span className='text-white text-lg'><MdOutlineMailOutline /></span>sahilbahl003@gmail.com</div>
        </div>
